...
# ───────────────────────────────────────────────
# ALTCHA + CEIR logic (unchanged from your last version)
# ───────────────────────────────────────────────
...
# ───────────────────────────────────────────────
# Webhook + Render free tier setup
# ───────────────────────────────────────────────
...
def main():
    ...
    # RENDER_EXTERNAL_HOSTNAME is auto-set (e.g. your-service-abc123.onrender.com)
    HOSTNAME = os.environ.get("RENDER_EXTERNAL_HOSTNAME")
    if not HOSTNAME:
        logger.warning("RENDER_EXTERNAL_HOSTNAME not found — using localhost for local testing")
        HOSTNAME = "localhost"
    ...
    application.run_webhook(
        ...
        drop_pending_updates=True,  # Clear queued updates on restart
    )
